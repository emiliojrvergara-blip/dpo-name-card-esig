...
function CardQRTab({ emp }) {
  ...
  return (
    <div style={{ paddingTop: 8 }}>
      ...
      <div style={{ background: C.surface, borderRadius: 16, padding: '16px', boxShadow: C.shadow, marginBottom: 40 }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: C.textSecondary, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 10 }}>
          Save as App on Your Phone
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 600, color: C.textPrimary, marginBottom: 2 }}>iPhone (Safari)</div>
              <div style={{ fontSize: 12, color: C.textSecondary, lineHeight: 1.5 }}>Tap the <strong>Share</strong> icon at the bottom → <strong>Add to Home Screen</strong> → <strong>Add</strong></div>
            </div>
          </div>
          <div style={{ height: 1, background: C.divider }} />
          <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
            <div style={{ width: 28, height: 28, borderRadius: 8, background: '#3ddc84', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <svg width={16} height={16} viewBox="0 0 24 24" fill="#fff"><path d="M17.6 9.48l1.84-3.18c.16-.31.04-.69-.26-.85-.29-.15-.65-.06-.83.22l-1.88 3.24A10.06 10.06 0 0012 8c-1.44 0-2.8.3-4.04.83L6.08 5.59c-.18-.28-.54-.37-.83-.22-.3.16-.42.54-.26.85L6.83 9.5C4.53 10.97 3 13.3 3 16h18c0-2.7-1.53-5.03-3.4-6.52zM9 13c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm6 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"/></svg>
            </div>
            <div>
              <div style={{ fontSize: 13, fontWeight: 600, color: C.textPrimary, marginBottom: 2 }}>Android (Chrome)</div>
              <div style={{ fontSize: 12, color: C.textSecondary, lineHeight: 1.5 }}>Tap the <strong>⋮ menu</strong> at the top right → <strong>Add to Home screen</strong> → <strong>Add</strong></div>
            </div>
          </div>
        </div>
      </div>
